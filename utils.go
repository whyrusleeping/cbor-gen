...
//
// In general, simple adapter methods can be written to make a CBORGeneric from a CBORSerializer,
// with the primary difference being that UnmarshalCBOR must take a pointer receiver, whereas
// CBORGeneric must be able to be implemented on value types in order to be flexible enough to
// handle both value and pointer types as generics.
